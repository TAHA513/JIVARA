...
import SunglassesLanding from "@/pages/sunglasses-landing";
            ...
            <div className="min-h-screen bg-background text-foreground" dir="rtl">
              {isWarrantyRoute ? (
                ...
                <Switch>
                  ...
                  <Route path="/sunglasses" component={SunglassesLanding} />
