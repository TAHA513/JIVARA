...
import multiImg from "@assets/651078564_122325293894011163_7590872850914663239_n_1775985170468.jpg";
...
const CAP_IMAGES = [navyImg, blackImg, grayImg, beigeImg, multiImg];
...
function genSession() {
  const stored = safeStorage.getItem("nw-session");
  if (stored) return stored;
  const id = "nw-" + Math.random().toString(36).substring(7);
  safeStorage.setItem("nw-session", id);
  return id;
}

export default function NaturalWalkerPage() {
    ...
    <div dir="rtl" className="min-h-screen bg-white font-sans">
      ...
      <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-black text-white py-5 px-4">
        <div className="max-w-xl mx-auto">
          ...
          {/* Pricing table in hero — clear and direct */}
      ...
      <div className="px-4 py-4 max-w-xl mx-auto">
        ...
        <div className="bg-gray-900 text-white rounded-2xl p-4 mb-4">
          ...
          {/* Live price badge — updates with every color tap */}
                  ...
                  onClick={() => {
                    ...
                    setSelectedColors(prev => {
                      const next = prev.includes(i)
                        ...
                        : [...prev, i];
                      // Auto-set package based on number of selected colors
          ...
          {/* Preview of hovered/clicked color */}
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-2xl p-5 mb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            {/* Final order summary before submit */}
      ...
      <footer className="bg-gray-900 text-gray-400 text-center py-4 px-4 text-xs">
        <p className="font-bold text-white text-sm mb-1">🇬🇧 NATURALWALKER — British Cap Since 1998</p>
